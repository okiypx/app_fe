...
var hongbaoCount=5;//每次빨간 봉투个数
var loadindex=0;
var loadtime=1500;//多少毫秒掉1次빨간 봉투
var slideSpeed=new Array(8000,12000)//빨간 봉투掉落速度（毫秒），取此之间的随机数
$(function()
{
    LoadHongBao();//首次打开网页 先执行1次下빨간 봉투
    setInterval(LoadHongBao,loadtime)//定时执行下빨간 봉투
