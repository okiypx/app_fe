...
function dgpar(seat, tableId) {
    ...
    var data = [{ hltype: hltype, hlstyle: hlstyle, gameid: gameid, game: game, tablename: tablename}]
    return data;
}
    ...
    var Dialog = (function() {
        ...
        Dialog.prototype = {
            _init: function() {
                ...
                self.isHided = false;
                self.tapBug = self._hasTapBug();
                self.platform = mobileUtil.platform;
            ...
            _bindEvents: function() {
                ...
                if(self.settings.autoClose > 0){
                    console.log(self.settings.autoClose/1000 +'秒后, 自动 취소弹窗');
                    self._autoClose();
                }
