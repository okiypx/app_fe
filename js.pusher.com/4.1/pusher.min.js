...
! function(t, e) {
    ...
    return function(t) {
        ...
        function o() {
            for (var t = ["Pusher"], e = 0; e < arguments.length; e++) "string" == typeof arguments[e] ? t.push(arguments[e]) : t.push(_(arguments[e]));
            return t.join(" : ")
        }
        ...
        function g(t) {
            return h(t, function(t) {
                return "object" == typeof t && (t = _(t)), encodeURIComponent(w.default(t.toString()))
            })
        }
            ...
            return function t(i, o) {
                ...
                switch (typeof i) {
                    case "object":
                        ...
                        if (e.push(i), n.push(o), "[object Array]" === Object.prototype.toString.apply(i))
                            for (a = [], r = 0; r < i.length; r += 1) a[r] = t(i[r], o + "[" + r + "]");
                        else {
                            a = {};
                            for (s in i) Object.prototype.hasOwnProperty.call(i, s) && (a[s] = t(i[s], o + "[" + JSON.stringify(s) + "]"))
                        }
                        return a;
                    case "number":
                    case "string":
        ...
        for (var o = String.fromCharCode, r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", s = {}, a = 0, c = r.length; a < c; a++) s[r.charAt(a)] = a;
        var u = function(t) {
        ...
        var S = {
            ...
            C = {
                ...
                def_transport: function(t, e, n, i, o, r) {
                    ...
                    var a, c = !(t.enabledTransports && l.arrayIndexOf(t.enabledTransports, e) === -1 || t.disabledTransports && l.arrayIndexOf(t.disabledTransports, e) !== -1);
            ...
            s = function() {
                ...
                return t.prototype.isSupported = function() {
                    ...
                    var n = this,
                        ...
                        s = null,
                        a = function(c, u) {
                            u ? e(null, u) : (o += 1, n.loop && (o %= i.length), o < i.length ? (r && (r *= 2, n.timeoutLimit && (r = Math.min(r, n.timeoutLimit))), s = n.tryStrategy(i[o], t, {
                                timeout: r,
                                failFast: n.failFast
                            }, a)) : e(!0))
                        };
        ...
        var a = n(11),
            ...
            h = function() {
                ...
                return t.prototype.isSupported = function() {
                    ...
                    var h = a.default.now(),
                        p = c.pop().connect(t, function i(o, u) {
                            o ? (s(n), c.length > 0 ? (h = a.default.now(), p = c.pop().connect(t, i)) : e(o)) : (r(n, u.transport.name, a.default.now() - h), e(null, u))
                        });
                    return {
                        abort: function() {
                            p.abort()
