window.ParsleyExtend = window.ParsleyExtend || {}, window.ParsleyExtend = $.extend(window.ParsleyExtend, {
        ...
        addAsyncValidator: function(a, b, c) {
            return this.asyncValidators[a.toLowerCase()] = {
                fn: b,
                url: c || !1
            }, this
        },
        ...
        onSubmitValidate: function(a) {
            ...
            if (!0 !== a.parsley) return this.submitEvent = $.extend(!0, {}, a), a instanceof $.Event && (a.stopImmediatePropagation(), a.preventDefault()), this._asyncValidateForm(void 0, a).done(function() {
                b.submitEvent.isDefaultPrevented() || b.$element.trigger($.extend($.Event("submit"), {
                    parsley: !0
                }))
            })
        },
        ...
        _remote: function(a) {
            var b, c, d = this,
                e = {},
                f = this.options.remoteValidator || (!0 === this.options.remoteReverse ? "reverse" : "default");
            ...
            e[this.$element.attr("name") || this.$element.attr("id")] = this.getValue(), b = $.extend(!0, {}, {
                url: this.asyncValidators[f].url || this.options.remote,
                data: e,
                type: "GET"
            }, this.options.remoteOptions || {}), c = $.param(b), "undefined" == typeof this._remoteCache && (this._remoteCache = {}), this._remoteCache[c] || (this._xhr && "pending" === this._xhr.state() && this._xhr.abort(), this._xhr = $.ajax(b), this._remoteCache[c] = this._xhr), this._remoteCache[c].done(function(b, c, e) {
